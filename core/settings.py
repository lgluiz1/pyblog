...
SECRET_KEY = 'django-insecure-7q)t9+xfx0i3uz(&zgieam-dfq7+j8m8g8z)qb2=!4wle9#&pd'
...
ALLOWED_HOSTS = [
    "localhost",
    "127.0.0.1",
    "736b-191-241-65-200.ngrok-free.app",  # <- adicione isso
]
...
MEDIA_ROOT = os.path.join(BASE_DIR, 'media')  # Pasta onde os arquivos de mídia serão armazenados
